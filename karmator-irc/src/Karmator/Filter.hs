...
commandMessage :: BS.ByteString -> BotEvent IRC.Message -> Bool
...
networkMatch :: String -> BotEvent IRC.Message -> Bool
...
nickMatch :: BS.ByteString -> BotEvent IRC.Message -> Bool
